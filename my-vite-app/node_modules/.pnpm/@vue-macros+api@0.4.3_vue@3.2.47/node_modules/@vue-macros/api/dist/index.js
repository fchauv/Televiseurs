...
var _chunk32PZ64CNjs = require('./chunk-32PZ64CN.js');
    ...
    case "TSUnionType": {
      const types = (await Promise.all(
        node.type.types.map(async (subType) => {
          const resolved = await _chunk32PZ64CNjs.resolveTSReferencedType.call(void 0, {
            scope: node.scope,
            type: subType
          });
          return resolved && !_chunk32PZ64CNjs.isTSExports.call(void 0, resolved) ? inferRuntimeType(resolved) : void 0;
        })
      )).filter((t) => !!t).flat(1);
...
`);
  ...
  async function resolveDefinitions(typeDeclRaw2) {
    const resolved = await _chunk32PZ64CNjs.resolveTSReferencedType.call(void 0, typeDeclRaw2);
    if (!resolved || _chunk32PZ64CNjs.isTSExports.call(void 0, resolved))
    ...
    if (definitionsAst2.type === "TSIntersectionType") {
      ...
      throw new SyntaxError(`Cannot resolve TS definition.`);
    const properties = await _chunk32PZ64CNjs.resolveTSProperties.call(void 0, {
      scope,
    ...
    for (const [key, value] of Object.entries(properties.properties)) {
      const referenced = value.value ? await _chunk32PZ64CNjs.resolveTSReferencedType.call(void 0, value.value) : void 0;
      definitions2[key] = {
        type: "property",
        addByAPI: false,
        value: referenced && !_chunk32PZ64CNjs.isTSExports.call(void 0, referenced) ? buildDefinition(referenced) : void 0,
  ...
  function buildDefinition({
    ...
    return {
      code: _chunk32PZ64CNjs.resolveTSScope.call(void 0, scope).file.content.slice(type.start, type.end),
      ast: type,
      scope
    };
  }
  ...
  async function resolveDefinitions(typeDeclRaw2) {
    ...
    for (const signature of properties.callSignatures) {
      ...
      if (!evtArg || evtArg.type !== "Identifier" || ((_a = evtArg.typeAnnotation) == null ? void 0 : _a.type) !== "TSTypeAnnotation")
        continue;
      const evtType = await _chunk32PZ64CNjs.resolveTSReferencedType.call(void 0, {
        type: evtArg.typeAnnotation.typeAnnotation,
        scope: signature.scope
      });
      if (_chunk32PZ64CNjs.isTSExports.call(void 0, evtType) || (evtType == null ? void 0 : evtType.type.type) !== "TSLiteralType")
        continue;
...
exports.DefinitionKind = DefinitionKind; exports.MagicString = _common.MagicString; exports.analyzeSFC = analyzeSFC; exports.attachNodeLoc = attachNodeLoc; exports.exportsSymbol = _chunk32PZ64CNjs.exportsSymbol; exports.getTSFile = _chunk32PZ64CNjs.getTSFile; exports.handleTSEmitsDefinition = handleTSEmitsDefinition; exports.handleTSPropsDefinition = handleTSPropsDefinition; exports.inferRuntimeType = inferRuntimeType; exports.isTSDeclaration = _chunk32PZ64CNjs.isTSDeclaration; exports.isTSExports = _chunk32PZ64CNjs.isTSExports; exports.keyToString = _chunk5IUQDHHYjs.keyToString; exports.mergeTSProperties = _chunk32PZ64CNjs.mergeTSProperties; exports.parseSFC = _common.parseSFC; exports.resolveTSEntityName = _chunk32PZ64CNjs.resolveTSEntityName; exports.resolveTSExports = _chunk32PZ64CNjs.resolveTSExports; exports.resolveTSFileId = _chunk32PZ64CNjs.resolveTSFileId; exports.resolveTSFileIdNode = _chunk32PZ64CNjs.resolveTSFileIdNode; exports.resolveTSProperties = _chunk32PZ64CNjs.resolveTSProperties; exports.resolveTSReferencedType = _chunk32PZ64CNjs.resolveTSReferencedType; exports.resolveTSScope = _chunk32PZ64CNjs.resolveTSScope; exports.resolveTypeElements = _chunk32PZ64CNjs.resolveTypeElements; exports.setResolveTSFileIdImpl = _chunk32PZ64CNjs.setResolveTSFileIdImpl; exports.tsFileCache = _chunk32PZ64CNjs.tsFileCache; exports.tsFileExportsCache = _chunk32PZ64CNjs.tsFileExportsCache;
