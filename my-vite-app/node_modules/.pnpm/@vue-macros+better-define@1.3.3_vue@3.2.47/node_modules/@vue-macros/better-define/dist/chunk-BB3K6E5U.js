    ...
    return {
        ...
        if (meta.framework === "rollup" || meta.framework === "vite") {
          ...
          const resolveFn = async (id, importer) => {
            ...
            const tryResolve = async (id2) => {
              try {
                return await ctx.resolve(id2, importer) || ctx.resolve(`${id2}.d`, importer);
              } catch (e) {
                return;
              }
            };
            let resolved = (_a = await tryResolve(id)) == null ? void 0 : _a.id;
            if (!resolved)
              return;
            ...
            resolved = (_b = await tryResolve(resolved)) == null ? void 0 : _b.id;
      ...
      vite: {
        ...
        handleHotUpdate({ file, server, modules }) {
          ...
          if (_api.tsFileCache[file])
            delete _api.tsFileCache[file];
